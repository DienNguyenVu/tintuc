...
<div id="wrap-vp">
    ...
    <div id="vcl">
    	<div id=""><a href="login">ĐĂNG NHẬP</a></div>
        <div id=""><a href="login">ĐĂNG KÍ</a></div>
    </div>
    ...
    <div id="slide-vp">
  	...
  	<div id="content-vp">
        ...
        <div id="content-main">
            ...
            <?php 
            switch ($p) {
                case "chitiettin":require_once"pages/chitiettin.php";
                    break;
                case "tintrongloai":require_once"pages/tintrongloai.php";
                    break;
                case "timkiem":require_once"pages/timkiem.php";
                    break;
